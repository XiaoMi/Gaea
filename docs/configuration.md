...
| max_sql_execute_time           | string    | 慢sql熔断时间，单位ms，为0表示不开启|
| max_select_result_set           | string    | 结果集最大行数限制，避免结果集过大导致oom |
...
```
{
    ...
    "max_sql_execute_time": "3600000",
    "max_select_result_set": "5000"
}
```
