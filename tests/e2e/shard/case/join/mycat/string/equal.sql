...
select a.id,b.id,b.pad,a.t_id from test1 a,(select * from sbtest.test2 where pad>3) b where a.t_id=b.o_id;
...
select test1.id,test1.t_id,test1.name,test1.pad,sbtest.test2.id,sbtest.test2.o_id,sbtest.test2.name,sbtest.test2.pad from test1 natural left join sbtest.test2;
select test1.id,test1.t_id,test1.name,test1.pad,sbtest.test2.id,sbtest.test2.o_id,sbtest.test2.name,sbtest.test2.pad from test1 natural right join sbtest.test2;
select test1.id,test1.t_id,test1.name,test1.pad,sbtest.test2.id,sbtest.test2.o_id,sbtest.test2.name,sbtest.test2.pad from test1 natural left outer join sbtest.test2;
select test1.id,test1.t_id,test1.name,test1.pad,sbtest.test2.id,sbtest.test2.o_id,sbtest.test2.name,sbtest.test2.pad from test1 natural right outer join sbtest.test2;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from test1 a natural left join sbtest.test2 b order by a.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from test1 a natural right join sbtest.test2 b order by b.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from test1 a natural left outer join sbtest.test2 b order by a.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from test1 a natural right outer join sbtest.test2 b order by b.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from test1 a natural left join (select * from sbtest.test2 where pad>2) b order by a.id,b.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from test1 a natural right join (select * from sbtest.test2 where pad>2) b order by a.id,b.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from test1 a natural left outer join (select * from sbtest.test2 where pad>2) b order by a.id,b.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from test1 a natural right outer join (select * from sbtest.test2 where pad>2) b order by a.id,b.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from (select * from test1 where pad>1) a natural left join (select * from sbtest.test2 where pad>3) b order by a.id,b.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from (select * from test1 where pad>1) a natural right join (select * from sbtest.test2 where pad>3) b order by a.id,b.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from (select * from test1 where pad>1) a natural left outer join (select * from sbtest.test2 where pad>3) b order by a.id,b.id;
select a.id,a.t_id,a.name,a.pad,b.id,b.o_id,b.name,b.pad from (select * from test1 where pad>1) a natural right outer join (select * from sbtest.test2 where pad>3) b order by a.id,b.id;
...
select distinct b.pad,a.pad from test1 a,(select * from sbtest.test2 where pad=1) b where a.t_id=b.o_id;
...
select C_NAME from sbtest.test6 where C_NAME like 'A__A';
select C_NAME from sbtest.test6 where C_NAME like 'm___i';
select C_NAME from sbtest.test6 where C_NAME like 'ch___i%%';
select C_NAME from sbtest.test6 where C_NAME like 'ch___i%%' ESCAPE 'i';
select count(*) from sbtest.test6 where C_NAME not like 'chen%';
select count(*) from sbtest.test6 where not (C_NAME like 'chen%');
select C_NAME from sbtest.test6 where C_NAME like binary 'chen%';
select C_NAME from sbtest.test6 where C_NAME like 'chen%';
select C_NAME from sbtest.test6 where  C_NAME  like concat('%','AM','%');
select C_NAME from sbtest.test6 where  C_NAME  like concat('%','en','%');
...
select a.c_CUSTKEY,a.C_NAME,b.O_ORDERKEY from sbtest.test6 as a left join test8 b using(id) where a.C_CUSTKEY<'CUSTKEY_300';
select a.c_CUSTKEY,a.C_NAME,b.O_ORDERKEY from sbtest.test6 as a left OUTER join test8 b using(id);
select a.c_CUSTKEY,a.C_NAME,b.O_ORDERKEY from test8 b right join sbtest.test6 as a using(id) where a.c_CUSTKEY<'CUSTKEY_300';
select a.c_CUSTKEY,a.C_NAME,b.O_ORDERKEY from test8 b right join sbtest.test6 as a  using(id);
...
select * from sbtest.t1 where id > 4 and id <=8 order by col1 desc;
select 1 as a from t order by a;
select * from sbtest.t1 where id > 1 order by id desc limit 10;
select * from sbtest.t2 where id < 0;
...
select a.id,b.id,b.pad,a.t_id from test1 a,(select all * from sbtest.test2) b where a.t_id=b.o_id;
select a.id,b.id,b.pad,a.t_id from test1 a,(select distinct * from sbtest.test2) b where a.t_id=b.o_id;
select id,o_id,name,pad from (select * from sbtest.test2 a group by a.id) a;
select * from (select pad,count(*) from sbtest.test2 a group by pad) a;
select a.id,b.id,b.pad,a.t_id from test1 a,(select * from sbtest.test2 having pad>3) b where a.t_id=b.o_id;
select a.id,b.id,b.pad,a.t_id from test1 a,(select * from sbtest.test2 where pad>3 order by id) b where a.t_id=b.o_id;
...
select * from (select m.id,n.pad from test1 m,sbtest.test2 n where m.id=n.id AND m.name='test中id为1' and m.pad>7 and m.pad<10)a;
