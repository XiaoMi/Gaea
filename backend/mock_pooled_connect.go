...
// MockPooledConnect is an autogenerated mock type for the MockPooledConnect type
type MockPooledConnect struct {
	mock.Mock
}

// Begin provides a mock function with given fields:
func (_m *MockPooledConnect) Begin() error {
	ret := _m.Called()
...
func (_m *MockPooledConnect) Close() {
	_m.Called()
}

// Commit provides a mock function with given fields:
func (_m *MockPooledConnect) Commit() error {
	ret := _m.Called()
...
func (_m *MockPooledConnect) Execute(sql string) (*mysql.Result, error) {
	ret := _m.Called(sql)
...
func (_m *MockPooledConnect) FieldList(table string, wildcard string) ([]*mysql.Field, error) {
...
func (_m *MockPooledConnect) GetAddr() string {
	ret := _m.Called()
...
func (_m *MockPooledConnect) IsClosed() bool {
	ret := _m.Called()
...
func (_m *MockPooledConnect) Reconnect() error {
	ret := _m.Called()
...
func (_m *MockPooledConnect) Recycle() {
	_m.Called()
}

// Rollback provides a mock function with given fields:
func (_m *MockPooledConnect) Rollback() error {
	ret := _m.Called()
...
func (_m *MockPooledConnect) SetAutoCommit(v uint8) error {
	ret := _m.Called(v)
...
func (_m *MockPooledConnect) SetCharset(charset string, collation mysql.CollationID) (bool, error) {
...
func (_m *MockPooledConnect) SetSessionVariables(frontend *mysql.SessionVariables) (bool, error) {
...
func (_m *MockPooledConnect) UseDB(db string) error {
	ret := _m.Called(db)
...
func (_m *MockPooledConnect) WriteSetStatement() error {
	ret := _m.Called()
