...
func (_m *ConnectionPool) Open() error {
	ret := _m.Called()
...
type mockConstructorTestingTNewConnectionPool interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewConnectionPool(t mockConstructorTestingTNewConnectionPool) *ConnectionPool {
	mock := &ConnectionPool{}
	mock.Mock.Test(t)
